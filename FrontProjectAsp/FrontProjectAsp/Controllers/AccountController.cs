using FrontProjectAsp.Helpers.Enums;
using FrontProjectAsp.Models;
using FrontProjectAsp.ViewModels.Accounts;
...
namespace FrontProjectAsp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SignUp(RegisterVM request)
        {
            ...
            ////Create edende role vermek ucun
        ...
        public async Task<IActionResult> SignIn(LoginVM request)
        {
            ...
            //if exist user null(yoxlayir),1ci hisse null-dirsa 2cini deyilse ele 1ci hisseni(sol) goturur
